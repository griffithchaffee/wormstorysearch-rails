class Scheduler::Test < ApplicationTestCase
  ...
  testing "update_stories" do
    # archived stories
    archived_story1 = FactoryBot.create(:story, is_archived: true)
    archived_story2 = FactoryBot.create(:story, is_archived: true)
    FactoryBot.create(:spacebattles_story, story: archived_story1)
    # missing author stories
    missing_author_story1 = FactoryBot.create(:story, author: nil)
    missing_author_story2 = FactoryBot.create(:story, author: nil)
    missing_author_story2_location = FactoryBot.create(:spacebattles_story, story: missing_author_story2)
    ...
    # duplicate stories
    duplicate_story1 = FactoryBot.create(:story)
    duplicate_story2 = FactoryBot.create(:story, title: duplicate_story1.title, author: duplicate_story1.author)
