class LocationSearcher::QuestionablequestingSearcher::Test < ApplicationTestCase
  ...
  testing "sfw stories" do
    ...
    assert_equal(
      {
        ...
        "chapter_updated_at"=>"2018-02-04 00:00:00 -0800",
        "likes"=>"0",
        "likes_updated_at"=>"",
        "location_path"=>"/threads/i-am-ziz-worm-si-simurgh.7044/",
        "position"=>"1",
    ...
    assert_equal(4100, questionablequesting_story.word_count)
  end
  ...
  testing "nsfw stories" do
    ...
    assert_equal(
      {
        ...
        "read_url"=>
         "https://forum.questionablequesting.com/threads/ah-fuck-it-im-hungry-worm-cyoa-si.7074",
    ...
    assert_equal(
      {
        "category"=>"chapter",
        "chapter_created_on"=>"2018-03-22",
        "chapter_updated_at"=>"2018-03-22 08:42:29 -0700",
        "likes"=>"0",
        "likes_updated_at"=>"",
        "location_path"=>
         "/threads/ah-fuck-it-im-hungry-worm-cyoa-si.7074/page-2#post-1830377",
        "position"=>"3",
        "title"=>"Static 3",
        "word_count"=>"1700"
      }.sort.to_h,
    ...
    assert_equal(4500, questionablequesting_story.word_count)
  end
  ...
  testing "sfw quests" do
    ...
    assert_equal(
      {
        "category"=>"chapter",
        "chapter_created_on"=>"2017-04-09",
        "chapter_updated_at"=>"2017-04-09 00:00:00 -0700",
        "likes"=>"0",
        "likes_updated_at"=>"",
        "location_path"=>"/threads/flesh-and-steel-worm-tinker-quest.5473/",
        "position"=>"1",
    ...
    assert_equal(2920, questionablequesting_story.word_count)
  end
    ...
    assert_equal(
       {
        ...
        "chapter_updated_at"=>"2018-03-15 00:00:00 -0700",
        "likes"=>"0",
        "likes_updated_at"=>"",
        "location_path"=>"/threads/relationship-trouble-worm.7263/",
        "position"=>"1",
